...
Namespace Mukesh.SBOLib
    ...
    Public Class GeneralFunctions
        ...
        End Function
        Public Function GetDateForDDMMYYYY(ByVal DateString As String) As String
            sDate = objAddOn.objGenFunc.GetDateTimeValue(DateString)
            sDate = sDate.Substring(6, 4) + sep + sDate.Substring(3, 2) + sep + sDate.Substring(0, 2)
            Return sDate
        End Function
